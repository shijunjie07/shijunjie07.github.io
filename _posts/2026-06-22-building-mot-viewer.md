...
<figure>
  <img src="{{ '/assets/img/sportsmot_val_v_i2_L4qquVg0_c009_frame_000238_Ground_Truth_Detections.png' | relative_url }}" alt="MOTScope visualization">
  <figcaption>MOTScope visualization of detections on a sports broadcast frame.</figcaption>
</figure>
...
<figure>
  <img src="{{ '/assets/img/motscope_interface.png' | relative_url }}" alt="MOTScope interface">
  <figcaption>MOTScope interface for browsing MOT-style image sequences and annotations.</figcaption>
</figure>
